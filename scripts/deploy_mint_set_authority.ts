...
deployMintAndSetAuthority()
    .then(() => console.log('Mint deployment and authority setting completed successfully.'))
    .catch((error) => {
        console.error('An error occurred during mint deployment and authority setting:', error);
